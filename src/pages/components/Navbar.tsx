                    ...
                    <div className="flex justify-between py-4">
                        ...
                        <div className="flex items-center space-x-2 lg:space-x-5">
                            <nav className="hidden lg:flex items-center space-x-2">
                                <Link href="#" className="group text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded-lg text-gray-800 border border-transparent hover:text-indigo-600 hover:bg-indigo-50 active:border-indigo-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700 dark:active:border-gray-600">
