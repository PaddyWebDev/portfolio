...
export default function NavLogo() {
    return (
        <Link href={"/"} className="group inline-flex items-center space-x-2 font-bold font-mono text-lg tracking-wide text-gray-900 hover:text-gray-600 dark:text-gray-100 dark:hover:text-gray-300">
