...
export default function SkillsSection() {
    ...
    return (
        <section className="w-full h-screen bg-neutral-100 dark:bg-neutral-900 flex items-center   " id="skills">
            <div className="container space-y-12 px-4 md:px-6 ">
                <motion.div
                    ...
                    <div className="space-y-2">
                        <div className="inline-block rounded-lg bg-neutral-200 px-3 py-1 text-sm dark:bg-neutral-700 dark:text-neutral-50">
                            Technical Skills
                        </div>
    ...
    return (
        skillList.map((skill, id: number) => (
            <motion.div
                ...
                key={id}
                className=" bg-neutral-50 dark:bg-neutral-950 p-3 rounded shadow-md  "
            >
